...
- Did we add qhality tests? Prefer fewer high quality tests. Prefer integration tests for user flows.
- Were there schema changes which could remain a database migration?
...
- Investigate and Fix issues whenever comes. 